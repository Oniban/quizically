    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div>
                    <label className="block text-sm text-gray-800 dark:text-gray-200 font-medium mb-1">Full Name</label>
                    <input
                        type="text"
                ...
                <div>
                    <label className="block text-sm text-gray-800 dark:text-gray-200 font-medium mb-1">Confirm Password</label>
                    <input
                        type="password"
